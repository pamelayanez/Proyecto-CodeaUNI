...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_3.setPixmap(QtGui.QPixmap("./Imagenes/carro.jpeg"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.label = QtWidgets.QLabel(self.frame_2)
        self.label.setGeometry(QtCore.QRect(90, 220, 71, 91))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("./Imagenes/coche.jpeg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.frame_2)
        self.label_2.setGeometry(QtCore.QRect(90, 360, 71, 81))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("./Imagenes/regalo.jpeg"))
